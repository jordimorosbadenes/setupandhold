---
slug: android-apple
title: "Cuando me compré un iPhone siendo chico Android"
description: "Una historia personal: de noches flasheando ROMs a comprar un iPhone, y luego volver a Android."
date: 2026-02-21
tags: [android, iphone, relatos]
hero:
  src: /img/android-apple.png
  alt: Header
  height: 300
  mobileHeight: 150
  position: "center"
...
<div style="margin:14px 0;padding:0 16px;border:1px solid #ccc;border-radius:8px;background:rgba(0,0,0,0.02);">
	<a href="https://xdaforums.com/t/galaxy-s4-gt-i9500-hard-brick-infinite-loop.3146515/" target="_blank" rel="noopener noreferrer" style="display:block;text-decoration:none;">
		<div style="display:flex;gap:12px;align-items:center;">
			<img src="https://i.ytimg.com/vi/uRyrg5SoWUQ/maxresdefault.jpg" alt="XDA-Developers" style="width:120px;height:120px;border-radius:6px;object-fit:cover;flex-shrink:0;" />
			<div style="flex:1;min-width:0;">
				<h4 style="margin:0 0 4px 0;color:inherit;">Galaxy s4 GT-I9500 hard brick (Infinite loop)</h4>
				<p style="margin:0 0 6px 0;font-size:13px;color:inherit;opacity:0.8;">XDA Forums</p>
				<p style="margin:0;font-size:12px;color:inherit;opacity:0.6;">xdaforums.com</p>
			</div>
		</div>
	</a>
</div>
